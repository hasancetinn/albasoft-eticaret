                    ...
                    <div class="row">
                        @foreach($products as $product)
                            <div class="col-md-3 product">
                                <a href="{{route('product-list',$product->slug)}}"><img src="http://lorempixel.com/400/400/food/1"></a>
                                <p><a href="#">{{$product->product_name}}</a></p>
                                <p class="price">{{$product->price}}</p>
                                <p><a href="{{route('product-list',$product->slug)}}" class="btn btn-theme">Ürün Detay</a></p>
                            </div>
                        @endforeach
